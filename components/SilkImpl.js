...
const SilkImpl = ({ speed = 5, scale = 1, color = "#6690FF", color2 = "#E0E7EF", noiseIntensity = 1.5, rotation = 0 }) => {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      uColor1: { value: new Color(...hexToNormalizedRGB(color)) },
